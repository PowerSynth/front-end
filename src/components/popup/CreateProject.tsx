...
const CreateProject: React.FC<{popupIsOpen: any, closePopup: any}> = ({popupIsOpen, closePopup}) => {
    ...
    const [isInitialStructureAndLayoutOpen, setInitialStructureAndLayoutOpen] = useState(false)
	...
	const handleDefaultMaterials = () => {
        ...
        setInitialStructureAndLayoutOpen(wasInitialStructureAndLayoutOpen => !wasInitialStructureAndLayoutOpen)
	};
        ...
        <Overlay className={Classes.OVERLAY_SCROLL_CONTAINER} isOpen={popupIsOpen}>
            <div className="popup-container">
                <Card className="popup-card">
                        ...
                        <div className="popup-container">
                            {!isInitialStructureAndLayoutOpen &&
                                <p className="popup-container-text">Would you like to edit the materials list?<br></br>
                        ...
                        {!isInitialStructureAndLayoutOpen &&
                            <div className="buttons-container">
                                ...
                                <Button text="Cancel" className="cancel-button-full" onClick={closePopup} />
                            </div>
                        }
                        {isInitialStructureAndLayoutOpen &&
                            <div className="buttons-container">
